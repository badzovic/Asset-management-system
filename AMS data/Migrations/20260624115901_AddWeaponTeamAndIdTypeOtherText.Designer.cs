...
namespace AMS_data.Migrations
{
    ...
    [Migration("20260624115901_AddWeaponTeamAndIdTypeOtherText")]
    partial class AddWeaponTeamAndIdTypeOtherText
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AMS_data.Entities.Weapons.Weapon", b =>
                {
                    ...
                    b.Property<string>("IdTypeOtherText")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AMS_data.Entities.Weapons.Weapon", b =>
                {
                    ...
                    b.HasOne("AMS_data.Entities.Lookups.LookupItem", "TeamLookup")
                        .WithMany()
                        .HasForeignKey("TeamLookupId");
